...
const autoPromoteElement = document.getElementById("autoPromote") || {checked: false};
const autoLearnElement = document.getElementById("autoLearn") || {checked: false};
...
// Developer-requested: multiply only XP gain by 1000000 (does NOT change XP required for level)
// This is a numeric multiplier, so it will persist in saves.
addGlobalXpMultiplier(1000000)